...
<body>
	<header class="title" role="banner" style="box-shadow:0px 3px 10px rgba(3,3,3,0.3);height:70px;">
		<div class="browserVersion newBrowser">
			...
			<a href="../../index.php"><img src="../../imgs/konl.png" style="margin-left:22%;margin-top:-2px; height: 70px; width: 300px;"></a>
	...
	<section id="dg-container" class="dg-container" style="margin-top:45px">
		...
		<div class="dg-wrapper">
			<a href="#"><img src="images/K1.jpg" height:482 px width:316></a>
			<a href="#"><img src="images/K2.jpg"></a>
			<a href="#"><img src="images/K3.jpg"></a>
			<a href="#"><img src="images/K4.jpg"></a>
			<a href="#"><img src="images/K5.jpg"></a>
