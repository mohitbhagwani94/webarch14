...
<body class="noajax  home" background-color:red>
    ...
    <div id="container" class="container effect">
        <nav class="main_menu effect" role="navigation" style="position:absolute; z-index:63;">
            ...
            <li><a class="active" style="background-color:#e40e37" data-track="Faqs"><span>WORKS</span></a></li>
...
<div id="content" class="home">
    ...
    <center>
        <div style="width:1000px;height:500px;margin-top:25px; border-radius:15px; box-shadow:7px 7px 6px rgba(3,3,3,0.2)" >
         <iframe  width="1000" height="500" style="overflow:hidden; border-radius:15px;" src="./slider/workcontent.php"></iframe>
     </div>
 </center>
