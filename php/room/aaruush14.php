...
<html lang="en">
<head>
	<title>Webarch|Aarrush'14</title>
...
<body>
	<header class="title" role="banner" style="box-shadow:0px 3px 10px rgba(3,3,3,0.3);height:70px;">
		<div class="browserVersion newBrowser">
			...
			<a href="../../index.php"><img src="../../imgs/arsh14.png" style="margin-left:22%;margin-top:-2px; height: 70px; width: 200px;"></a>
	...
	<section id="dg-container" class="dg-container" style="margin-top:45px">
		...
		<div class="dg-wrapper">
			...
			<a href="https://www.youtube.com/watch?v=ETp6FN8wbYw"><img src="images/A148.jpg"></a>
			<a href="https://www.youtube.com/watch?v=a3ggPwy7aS0"><img src="images/A149.jpg"></a>
			<a href="#"><img src="images/A1410.jpg"></a>
		</div>
		<div class="des" style="color:#333;font-family:arial;">
			 SRM University's National Level Technomanagment Fest
			 <br/>
			 <a href="http://www.aaruush.net" style="color:#333;font-family:arial;">www.aaruush.net</a>
		</div>
		<nav>	
