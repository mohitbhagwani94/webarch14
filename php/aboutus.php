    ...
    <div id="container" class="container effect">
        <nav class="main_menu effect" role="navigation">
            ...
            <ul style="width:275px;">
                ...
                <li><a href="../index.php" data-title="" data-url="">HOMEPAGE</a></li>
                <li><a href="./workwedo.php"  data-track="Faqs"><span>WORK<em>s</em></span></a></li>
                ...
                <li><a href="#"  ><span>Feebback</span></a></li>
...
<header class="title" role="banner">
            <div class="browserVersion newBrowser">
                <img src="../imgs/webarch_logo.png" style="margin-left:100px;margin-top:-5px;">
                
               <img src="../imgs/srm_logo.png" style="margin-left:60%;;margin-top:-5px;">
            </div>
