...
<body class="noajax  home" background-color:red>
    ...
    <div id="container" class="container effect">
        <nav class="main_menu effect" role="navigation" style="position:absolute; z-index:33;">
            <span class="close"></span>
            <ul>
               <li class="lang-picker">
                    <a href="#">Menu<span class="lang-arrow"></span></a>
                    <!--<ul><li><a href="http://outdatedbrowser.com/br">brasileiro</a></li><li><a href="http://outdatedbrowser.com/cz">Česká republika</a></li><li><a href="http://outdatedbrowser.com/de">deutsch</a></li><li><a href="http://outdatedbrowser.com/es">español</a></li><li><a href="http://outdatedbrowser.com/fr">français</a></li><li><a href="http://outdatedbrowser.com/hu">magyar</a></li><li><a href="http://outdatedbrowser.com/nl">nederlands</a></li><li><a href="http://outdatedbrowser.com/pt">português</a></li><li><a href="http://outdatedbrowser.com/ru">русский</a></li><li><a href="http://outdatedbrowser.com/ua">Український</a></li></ul>
               --> </li>
                <li><a class="btnAjax  active" href="index.php" data-title="" data-url="">HOMEPAGE</a></li>
                <li><a class="btnAjax " href="http://outdatedbrowser.com/en/project" data-title="THE PROJECT" data-url="/project">THE PROJECT</a></li>
                <li><a class="btnAjax " href="http://outdatedbrowser.com/en/how" data-title="HOW TO USE IT" data-url="/how">HOW TO USE IT</a></li>
                <li><a href="https://github.com/burocratik/outdated-browser/wiki/FAQ" rel="external" data-track="Faqs"><span>FAQ<em>s</em></span></a></li>
                <li><a href="https://github.com/burocratik/outdated-browser" rel="external" data-track="Github"><span>RECRUITMENT PROCESS</span></a></li>
                <li><a href="http://www.burocratik.com/" rel="external" data-track="Burocratik"><span>Feedback</span></a></li>
            </ul>
        </nav>
     <div class="pusher">
    <!-- LOAD CONTENT -->
...
<div id="content" class="home">
    ...
    mohit-->
       ...
       <!-- </header>-->
       		...
       		<center>
       		<iframe  width="1000" height="500" style="overflow:hidden" src="./slider/index.php"></iframe>
        	</center>
